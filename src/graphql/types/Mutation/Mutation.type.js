...
type Mutation {
    addUser(email: String!, password: String!, role: String, name: String!, employeeId: String!): User
    updateUserRole(email: String!, role: String!, name: String!, employeeId: String!): User
